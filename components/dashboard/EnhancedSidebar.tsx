...
const navItems = [
  ...
  { id: 'meeting-status', label: 'Meeting Status', icon: Clock, badge: null },
  { id: 'uploads', label: 'Uploads', icon: Upload, badge: 'New' },
  { id: 'action-items', label: 'Action Items', icon: CheckSquare, badge: null },
  { id: 'email-agent', label: 'Email Agent', icon: Mail, badge: null },
  { id: 'ai-workspace', label: 'AI Workspace', icon: Sparkles, badge: null },
