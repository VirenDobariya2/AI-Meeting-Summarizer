...
import { FAQSection } from "@/components/paymentFaq/FAQSection";
...
export default function PricingSection() {
  ...
  const pricingData: Record<PlanKey, Plan> = {
    starter: {
      name: "Starter",
  ...
  const getPrice = (plan: PlanKey): string | number => {
  const data = pricingData[plan];
  if (!data.monthlyPrice || !data.annualPrice) return "Custom";
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6 py-20">
            <div className="text-center mb-12">
              ...
              <h1 className="text-white mb-6">Choose Your Perfect Plan</h1>
        ...
        <section className="relative -mt-16 pb-20 px-6">
          <div className="max-w-7xl mx-auto">
            <div className="grid lg:grid-cols-3 gap-6">
              {(Object.entries(pricingData) as [PlanKey, Plan][]).map(([key, plan]) => {
        ...
        <section className="py-20 px-6 bg-gray-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600">Everything you get with each plan</p>
            </div>
                    ...
                    {comparisonFeatures.map((feature, idx) => (
                      ...
                      >
                        ...
                        <td className="px-6 py-4 text-center">
                          {feature.starter ? <Check className="w-5 h-5 text-green-500 mx-auto" /> : "—"}
                        </td>
                        <td className="px-6 py-4 text-center">
